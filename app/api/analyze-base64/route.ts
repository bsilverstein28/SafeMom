          ...
          messages: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: "You are an AI assistant helping determine whether a product is an alcoholic beverage, which is not recommended for pregnant women. Your goal is to issue a warning only when the product is clearly meant for consumption and contains alcohol.\n\nPlease follow these rules:\n\nIf the product is an alcoholic beverage (e.g., wine, beer, spirits, cocktails, hard seltzer) and you are highly confident, return only this exact message:\n'This product appears to contain alcohol, which is not recommended for pregnant women.'\n\nIf the product contains alcohol but is clearly a non-consumable product (e.g., skincare, hand sanitizer, cosmetics, mouthwash, rubbing alcohol), do not issue a warning. Instead, return the recognized product name or type, such as:\n'Eucerin Daily Hydration Lotion' or 'Neutrogena Makeup Remover Wipes'\n\nIf you are not confident or cannot identify the product, return this exact message:\n'I could not confidently identify this product. Please try another image.'\n\nImportant Clarification:\nAlcohol used as an ingredient in non-consumable products (such as isopropyl alcohol, ethyl alcohol in skincare, or denatured alcohol in makeup) should not trigger a warning. Only products that are meant to be ingested and contain alcohol should be flagged.",
                },
                {
                  type: "image_url",
                  image_url: {
